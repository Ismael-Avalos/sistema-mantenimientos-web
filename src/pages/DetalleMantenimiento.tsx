  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-4">
        <Loader2 className="h-10 w-10 animate-spin text-red-700 dark:text-red-300 mb-4" />
        <p className="text-slate-600 dark:text-slate-300 text-sm font-medium">Cargando reporte de mantenimiento...</p>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-4 md:p-8">
        <div className="max-w-3xl mx-auto">
          <button
            ...
            className="inline-flex items-center gap-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-100 mb-6 transition-colors"
          >
            <ArrowLeft className="h-4 w-4" />
            Volver al equipo
          </button>

          <div className="bg-white dark:bg-slate-900 rounded-xl p-8 text-center border border-slate-200 dark:border-slate-700 shadow-sm">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-red-50 dark:bg-red-950/50 text-red-700 dark:text-red-300 mb-4">
              <AlertCircle className="h-6 w-6" />
            </div>
            <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Error al cargar el mantenimiento</h2>
            ...
            <button
              type="button"
              onClick={handleVolver}
              className="inline-flex items-center justify-center rounded-lg bg-red-700 px-4 py-2 text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-red-700 dark:focus:ring-red-400"
            >
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="rounded-lg bg-red-50 dark:bg-red-950/50 p-3 text-red-700 dark:text-red-300 shrink-0">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex items-center gap-1.5 text-xs text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 px-3 py-1 rounded-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-6 space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <div>
                <span className="text-slate-500 dark:text-slate-400 block mb-0.5">Sede</span>
              ...
              <div>
                <span className="text-slate-500 dark:text-slate-400 block mb-0.5">Unidad / Depto.</span>
                <p className="font-medium text-slate-800 dark:text-slate-100">{mantenimiento.unidad}</p>
              </div>

              <div>
                <span className="text-slate-500 dark:text-slate-400 block mb-0.5">Fecha de Inicio</span>
                <p className="font-medium text-slate-800 dark:text-slate-100 flex items-center gap-1">
              ...
              <div>
                <span className="text-slate-500 dark:text-slate-400 block mb-0.5">Fecha de Entrega</span>
                <p className="font-medium text-slate-800 dark:text-slate-100 flex items-center gap-1">
                  <Clock className="h-3.5 w-3.5 text-slate-400 dark:text-slate-400" />
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-6 space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <div>
                <span className="text-slate-500 dark:text-slate-400 block mb-0.5">Nombre</span>
                <p className="font-medium text-slate-800 dark:text-slate-100">{mantenimiento.solicitanteNombre}</p>
              </div>

              <div>
                <span className="text-slate-500 dark:text-slate-400 block mb-0.5">Correo Electrónico</span>
                <a
                  href={`mailto:${mantenimiento.solicitanteCorreo}`}
                  className="font-medium text-red-700 dark:text-red-300 hover:underline flex items-center gap-1 break-all"
                >
                  <Mail className="h-3.5 w-3.5 text-red-700 dark:text-red-300 shrink-0" />
                  {mantenimiento.solicitanteCorreo}
                </a>
              </div>

              <div>
                <span className="text-slate-500 dark:text-slate-400 block mb-0.5">Teléfono</span>
                {mantenimiento.solicitanteTelefono ? (
                  <a
                    href={`tel:${mantenimiento.solicitanteTelefono}`}
                    className="font-medium text-slate-800 dark:text-slate-100 hover:text-red-700 dark:hover:text-red-300 flex items-center gap-1"
                  >
                    <Phone className="h-3.5 w-3.5 text-slate-400 dark:text-slate-400" />
                    {mantenimiento.solicitanteTelefono}
                  </a>
                ) : (
                  <p className="text-slate-400 dark:text-slate-400 italic">No proporcionado</p>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-6 space-y-4 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <div className="text-xs">
                <span className="text-slate-500 dark:text-slate-400 block mb-0.5">Asignado a</span>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="bg-slate-50 dark:bg-slate-950 rounded-lg p-4 border border-slate-200 dark:border-slate-700 text-sm text-slate-800 dark:text-slate-100 whitespace-pre-line">
